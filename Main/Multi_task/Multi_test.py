...
model = load_model('/home/pmcn/workspace/CPE_AI/Resnet50/checkpoint/More_task/300/9_class/weights_best-0.9444.hdf5')
...
def fusion(X_test,Y_test):
    ...
    #     fpr[i], tpr[i], _ = roc_curve(Y_test[:, i], new_pred[:, i])
    #     roc_auc[i] = auc(fpr[i], tpr[i])

    # # Compute micro-average ROC curve and ROC area
    # fpr["micro"], tpr["micro"], _ = roc_curve(Y_test.reval(), new_pred)
